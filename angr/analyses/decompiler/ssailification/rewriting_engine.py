...
class SimEngineSSARewriting(SimEngineNostmtAIL[RewritingState, Expression, Statement | tuple[Statement, ...], None]):
    """
    ...
    def _handle_expr_VEXCCallExpression(self, expr: VEXCCallExpression) -> VEXCCallExpression | None:
        ...
        if updated:
            return VEXCCallExpression(expr.idx, expr.cee_name, tuple(new_operands), bits=expr.bits, **expr.tags)
        return None
